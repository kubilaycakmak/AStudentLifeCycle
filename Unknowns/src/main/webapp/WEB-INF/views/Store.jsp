...
<%--                                data-toggle="modal" data-target="#myModal">Live!--%>
<%--                        </button> <!-- Modal -->--%>
...
<%--                                        <textarea id="usersTextArea" rows="10" cols="10"--%>
<%--                                                  readonly="readonly"></textarea>--%>
<%--                                        <br> <input id="textMessage" size="52" type="text"--%>
<%--                                                    value="${user.nickname }"><input type="button"--%>
<%--                                                                                     onclick="sendMessage();"--%>
<%--                                                                                     id="sendButton" value="Send">--%>
...
<%--                                                "ws:///192.168.137.1:8080/ChatServer/endpointserverdemo");--%>
<%--                                            var messagesTextArea = document--%>
<%--                                                .getElementById("messagesTextArea");--%>
<%--                                            webSocket.onmessage = function processMessage(--%>
<%--                                                message) {--%>
<%--                                                var jsonData = JSON--%>
<%--                                                    .parse(message.data);--%>
        ...
        <div id="ppm-main">
            <div id="ppm-content" role="main" class="content">
                        ...
                        <div id="stats">
                            <table align="center">
                                ...
                                <tr>
                                    ...
                                    <td>Money:</td>
                                    <td class="stat"><strong>$
                                        ${user.userinfo.money}</strong></td>
                                </tr>
                                <tr>
                                    <td>Experience:</td>
                ...
                <div id="ctl00_cphLeftColumn_ctl00_divRecentEvents" class="box">
                    <h2>STORE</h2>
                    <table class="data"
                           style="border-spacing: 30 !important;
                            float: none;
                            margin: 5 10 5px !important;
                            height: 300;
                        ...
                        <form method="POST">
                            <c:if test="${user.userinfo.company != null}">
                                ...
                                <tr>
                                    ...
                                    <th colspan="1" class="single">Hoursly&nbsp;</th>
                                    <th colspan="1" class="single">Own&nbsp;</th>
                                </tr>
                                <tr class="odd">
                                    <td class="width40" id="stamina">Dell PowerEdge T30
                                        Server
                                    </td>
                                    <td id="cstamina">3.3 GHZ Intel XEON</td>
                                    <td id="cstamina">$10000</td>
                                    <td><input formaction="/buy=1" type="submit" value="buy"></td>
                                    <td id="cstamina">$100</td>
                                    <td id="cstamina">${user.userinfo.company.items.count1}</td>
                                </tr>
                                <tr class="even">
                                    <td class="width40" id="stamina">DELL PowerEdge T140
                                        server
                                    </td>
                                    <td id="cstamina">3.5 GHz Intel Xeon E-2124</td>
                                    <td id="cstamina">$20000</td>
                                    <td><input formaction="/buy=2" type="submit" value="buy"></td>
                                    <td id="cstamina">$200</td>
                                    <td id="cstamina">${user.userinfo.company.items.count2}</td>
                                </tr>
                                <tr class="odd">
                                    <td class="width40" id="stamina">Lenovo ThinkSystem ST50
                                        server
                                    </td>
                                    <td id="cstamina">3.7 GHz Intel Xeon E-2124G</td>
                                    <td id="cstamina">$50000</td>
                                    <td><input formaction="/buy=3" type="submit" value="buy"></td>
                                    <td id="cstamina">$500</td>
                                    <td id="cstamina">${user.userinfo.company.items.count3}</td>
                                </tr>
                                <tr class="even">
                                    <td class="width40" id="stamina">Fujitsu PRIMERGY TX2550
                                        M4 server
                                    </td>
                                    <td id="cstamina">3.4 GHz Intel Xeon Gold 6128 Tower
                                        (4U)
                                    </td>
                                    <td id="cstamina">$80000</td>
                                ...
                                <tr class="odd">
                                    <td class="width40" id="stamina">DELL PowerEdge R240
                                        server
                                    </td>
                                    <td id="cstamina">4.2 GHz Intel Xeon E-2134</td>
                                    <td id="cstamina">$200000</td>
                                    <td><input formaction="/buy=5" type="submit" value="buy"></td>
                                    <td id="cstamina">$2000</td>
                            ...
                            <c:if test="${user.userinfo.company == null}">
                                <h4>
                                    You do not have any Company! So, why do you still waiting to <a
                                        href="Company">create one!</a>
                                </h4>
                            </c:if>
