...
<%--								data-toggle="modal" data-target="#myModal">Live!</button> <!-- Modal -->--%>
...
<%--												onclick="sendMessage();" id="sendButton" value="Send">--%>
				...
				<div id="ppm-content" role="main" class="content">
					<div class="box ofauto charPresBox">
						...
						<div class="float_left characterPresentation">
							<p>
								is a <strong> <c:if test="${user.userinfo.type == 1}">
                                Computer Student
                            </c:if> <c:if test="${user.userinfo.type == 2}">
                                Medicine Student
                            </c:if> <c:if test="${user.userinfo.type == 3}">
                                Law Student
                            </c:if>
							...
							<div id="stats">
								<table align="center">
									<tbody>
										...
										<tr>
											<td>Experience:</td>
											<td class="stat"><strong>${user.userinfo.xp}</strong>
											</p></td>
											<td>Company:</td>
					...
					<div id="bank">
						<img
							src="https://github.com/kubilayckmk/AStudentLifeCycle/blob/master/Unknowns/src/main/webapp/WEB-INF/views/assets/images/b.jpeg?raw=true"
							width="212px" height="140px">
						<p>We told you its dengerious when you save your money in your
							pocket, SO you should listen us!</p>
					</div>
					<div class="clear"></div>
					<div id="ctl00_cphLeftColumn_ctl00_divRecentEvents" class="box">
						...
						<ul class="noheader diaryExtraspace">
							...
							<form method="Post">
								<input type="number" placeholder="Enter value of money"
									name="checking"> <br>
								<br> <input formaction="/deposit" type="submit"
									value="Deposit" name="deposit"> <input
									formaction="/withdraw" type="submit" value="Withdraw"
									name="withdraw">
							</form>
						</ul>
					</div>
