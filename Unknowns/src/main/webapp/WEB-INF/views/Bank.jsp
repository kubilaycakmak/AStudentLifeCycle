        ...
        <div id="ppm-main">
            <div id="ppm-content" role="main" class="content">
                    ...
                    <div class="float_left characterPresentation">
                        ...
                        <div id="stats">
                            <table align="center">
                                ...
                                <tr>
                                    <td>Experience:</td>
                                    <td class="stat"><strong${user.userinfo.xp}</p></td>
                                    <td>Equipments:</td>
                ...
                <div id="bank">
                    ...
                    <p>We told you its dengerious when you save your money in your pocket, SO you should listen us!</p>
                </div>
                <div class="clear"></div>
                <div id="ctl00_cphLeftColumn_ctl00_divRecentEvents" class="box">
                    ...
                    <ul class="noheader diaryExtraspace">
                        ...
                        <form method="Post">
                            ...
                            <input formaction="/withdraw" type="submit" value="Withdraw" name="withdraw">
                        </form>
                    </ul>
                </div>
